...
<body>
    <header>
        <div class="logo logo_main">SMOOF</div> 
			...
			<h2 class="texnegrita" style="color: white;">El placer de la comida</h2>
            ...
            <h4 style="color: white;" class="texnegrita">Smoof mejor sitio de comidas</h4>
				</div>
            </center>
        <div class="contenido">
	<div>
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-4 col-md-4  col-md-3 pie_depag">
				...
				<center><a class="bott" href="comentarios.php">Dejar comentario</a></center>
			</article>
			<article class="col-xs-12 col-sm-4 col-md-4  col-md-3 pie_depag">
